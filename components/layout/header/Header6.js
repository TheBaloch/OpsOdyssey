                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <ul className="tg-header__top-info left-side list-wrap">
                                    <li><i className="flaticon-phone-call" /><Link href="tel:0123456789">+923004382099</Link></li>
                                    <li><i className="flaticon-pin" /> 159-J Johar Town, Lahore, Pakistan</li>
                                </ul>
                            </div>
                            <div className="col-lg-6">
                                <ul className="tg-header__top-right list-wrap">
                                    <li><i className="flaticon-envelope" /><Link href="mailto:info@opsodyssey.com">info@opsodyssey.com </Link></li>
                                    <li><i className="flaticon-time" />Mon-Fri: 9:00am - 09:00pm</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <nav className="tgmenu__nav">
                                        ...
                                        <div className="tgmenu__action tgmenu__action-three d-none d-md-block">
                                            <ul className="list-wrap">
                                                ...
                                                <li className="header-btn"><Link href="/contact" className="btn">Get in touch</Link></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="tgmobile__menu-bottom">
                                            <div className="contact-info">
                                                <ul className="list-wrap">
                                                    ...
                                                    <li><Link href="923004382099">+923004382099</Link></li>
                                                </ul>
                                            </div>
