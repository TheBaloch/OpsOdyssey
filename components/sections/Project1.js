...
export default function Project1() {
    return (
        <>
            <section className="project-area mt-0 pt-5  pb-4">
                        ...
                        <div className="row">
                                ...
                                <div className="project-item">
                                    ...
                                    <div className="project-content">
                                        <div className="left-side-content">
                                            <h4 className="title"><Link href="#">Web Development</Link></h4>
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="project-item">
                                    ...
                                    <div className="project-content">
                                        <div className="left-side-content">
                                            <h4 className="title"><Link href="#">Mobile Development</Link></h4>
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="project-item">
                                    ...
                                    <div className="project-content">
                                        <div className="left-side-content">
                                            <h4 className="title"><Link href="#">SEO</Link></h4>
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="project-item">
                                    <div className="project-thumb">
                                        <Link href="/project-details"><img src="/assets/img/project/sm.jpg" alt="" /></Link>
                                    </div>
                                    <div className="project-content">
                                        <div className="left-side-content">
                                            <h4 className="title"><Link href="#">Social Media Marketing</Link></h4>
                                            {/* <span>Inventory Tracking</span> */}
                                        </div>
                                        <div className="link-arrow">
                                            <Link href="/project-details">
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="project-item">
                                    <div className="project-thumb">
                                        <Link href="/project-details"><img src="/assets/img/project/dm.jpg" alt="" /></Link>
                                    </div>
                                    <div className="project-content">
                                        <div className="left-side-content">
                                            <h4 className="title"><Link href="/#">Digital Marketing</Link></h4>
                                            {/* <span>Inventory Tracking</span> */}
                                        </div>
                                        <div className="link-arrow">
                                            <Link href="/project-details">
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="project-item">
                                    ...
                                    <div className="project-content">
                                        <div className="left-side-content">
                                            <h4 className="title"><Link href="#">Latest UI/UX Design</Link></h4>
