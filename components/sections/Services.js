        ...
        <>
          ...
          <div className="col-lg-7">
            <div className="section-title text-center mb-50 tg-heading-subheading animation-style3">
                ...
                <h2 className="title tg-element-title">We Do World Class Work For You</h2>
                <p className="tg-element-title">Mauris ut enim sit amet lacus ornare ullamcorper Praesent plaacerat <br /> neque eu purus rhoncus vel tincidunt odio ultrices.</p>
            </div>
          </div>
          </div>
