    ...
    return (
        <>
             <section className="services__area-seven services__area-home7 services__bg-seven">
                <div className="icon-line"><img src="/assets/img/home7/icon-line.svg" /></div>
                <div className="icon-snow"><img src="/assets/img/home7/icon-snow.svg" /></div>
                <div className="icon-star"><img src="/assets/img/home7/icon-star.svg" /></div>
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-7">
                            <div className="section-title text-center mb-50">
                                <span className="sub-title">Our SOlutions</span>
                                <h2 className="title">Expert Financial and Accounting<br className="d-none d-lg-block" /> Services for Businesses</h2>
                            </div>
                        </div>
                    </div>
                    <div className="row justify-content-center gutter-24 services__item-style-2">
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="services__item-five">
                                ...
                                <div className="services__content-five">
                                    <h2 className="title"><Link href="/services-details">Financial Planning and Analysis</Link></h2>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="services__item-five">
                                ...
                                <div className="services__content-five">
                                    <h2 className="title"><Link href="/services-details">Tax Planning and Compliance</Link></h2>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="services__item-five">
                                ...
                                <div className="services__content-five">
                                    <h2 className="title"><Link href="/services-details">Bookkeeping and Payroll Services</Link></h2>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="services__item-five">
                                ...
                                <div className="services__content-five">
                                    <h2 className="title"><Link href="/services-details">Financial Reporting and Compliance</Link></h2>
