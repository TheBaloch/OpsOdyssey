...
export default function Testimonials() {
    return (
        <>
            <section className="testimonials_area-seve mb-30 ">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-6 col-lg-8">
                            <div className="section-title text-center mb-10 tg-heading-subheading animation-style3">
                                ...
                                <h2 className="title tg-element-title"> Our Work Speaks For Itself</h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <Swiper {...swiperOptions} className="swiper-wrapper">
                                <SwiperSlide className="swiper-slide slide__home7">
                                    <div className="item-testimonial">
                                        <div className="item-testimonial-left  ">
                                           ...
                                           <h2 className="title">Natty NYC</h2>
                                           </div>

                                            <p>Developed a feature-rich e-commerce mobile application for Natty NYC to deliver an advanced shopping experience based on personal recommendations, a fully tracked real-time inventory, and advanced ease of payment. The app supports a large catalogue and provides a user-friendly front end.</p>
                                            <h2 className="title mb-30" >Technology Stack</h2>
                                            <div className="about__list-box " >
                                            <ul className="list-wrap mb-4">
                                            <li><i className="flaticon-arrow-button" /> Frontend developed using Next.js</li>
                                             <li><i className="flaticon-arrow-button" />Backend powered by PHP and Laravel</li>
                                            </ul>
                                    </div>
                                        </div>
                                    </div>
                                ...
                                <SwiperSlide className="swiper-slide slide__home7">
                                    <div className="item-testimonial">
                                        ...
                                        <div className="section-title mb-30">
                                         <span className="sub-title">Project</span>
                                         <h2 className="title">Immigration Guru</h2>
                                         </div>
                                            <p>Immigration Guru is an innovative web-based solution aimed at bridging the gap between talented job seekers who want to go work abroad and employers looking for great foreign talent. The portal aims to make getting a job abroad easy with its user-friendly interface and rich resources available to both job seekers and employers.</p>
                                            <h2 className="title mb-30" >Technology Stack</h2>
                                            <div className="about__list-box " >
                                            <ul className="list-wrap mb-4">
                                            <li><i className="flaticon-arrow-button" /> Frontend developed using Next.js</li>
                                             <li><i className="flaticon-arrow-button" />Backend powered by Node.js</li>
                                            </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <SwiperSlide className="swiper-slide slide__home7">
                                    <div className="item-testimonial">
                                        ...
                                        <div className="section-title mb-30">
                                            <span className="sub-title">Project</span>
                                            <h2 className="title">Deliver Logic</h2>
                                        </div>                                            
                                            <p>DeliverLogic is a cutting-edge restaurant delivery software designed to streamline ordering, delivery, and customer support for businesses of all sizes. With advanced AI-driven logistics, online ordering integration, and 24/7 customer service, it boosts sales, enhances efficiency, and builds customer loyalty.</p>
                                            <h2 className="title mb-30" >Technology Stack</h2>
                                            <div className="about__list-box " >
                                            <ul className="list-wrap mb-4">
                                            <li><i className="flaticon-arrow-button" /> Frontend developed using Next.js</li>
